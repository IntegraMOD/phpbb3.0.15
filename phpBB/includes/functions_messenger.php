	...
	*/
	function msg_jabber()
	{
		...
		if (!$use_queue)
		{
			...
			$this->jabber = new jabber($config['jab_host'], $config['jab_port'], $config['jab_username'], htmlspecialchars_decode($config['jab_password'], ENT_COMPAT), $config['jab_use_ssl']);
...
// SMTP class has been heavily modified by Dion Designs to bring it up to modern email standards
