    ...
    $(function() {
        ...
        if ($sectionsPanel.length) {
            ...
            if (sectionsHTML) {
                ...
                $sectionsPanel.html(sectionsHTML).show();
            }
        }
        ...
        $('dt.name-term a').on('click', function(e) {
            e.preventDefault();
            $(this).parents('dt').siblings('dd').toggle();
        });
 
        $('#tabs.stats').find('.tab').on('click', function(evt) {
            evt.preventDefault();
            var showPanel = $(this).data('show-panel');
            $('#tabs.stats').find('.panel').hide();
            $('#' + showPanel).show();
            $('.tab').removeClass('activetab');
            $(this).addClass('activetab');
        });
 
        $('#tabs.stats').find('.activetab').trigger('click');
 
        $('dl.codebox > dt > a').on('click', function(e) {
            e.preventDefault();
