...
$lang = array_merge($lang, array(
	'TRANSLATION_INFO'	=> 'Український переклад &copy 2005-2015 <a class="copyright" target="_blank" href="http://phpbb.com.ua/">Українська підтримка phpBB</a>',
	'DIRECTION'	=> 'ltr',
	'DATE_FORMAT'	=> '|d M Y|',
	'USER_LANG'	=> 'uk',
	...
	'AVATAR_WRONG_FILESIZE'	=> 'Розмір файлу аватару повинен бути від 0 до %1$d %2$s.',
  ...
  'ERR_WATCHING'                  => 'Сталася помилка при спробі оформити підписку.',
	...
	'NEW_PM'	=> '<span class="badge text-bg-light rounded-pill align-text-bottom"><strong>%d</strong></span> нове повідомлення',
	'NEW_PMS'	=> '<span class="badge text-bg-light rounded-pill align-text-bottom"><strong>%d</strong></span> нових повідомлень',
	...
	'NO_NEW_PM'	=> '<span class="badge text-bg-light rounded-pill align-text-bottom"><strong>0</strong></span> нових повідомлень',
    ...
    'NO_STYLE_DATA'				=> 'Не вдається отримати дані стилів',
  ...
  'WRONG_DATA_COLOUR'			=> 'Введене вами значення кольору невірне.',
