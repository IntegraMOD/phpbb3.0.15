...
class umil_frontend extends umil
{
    ...
    */
    public function __construct(public $title = '', $auto_display_results = false, public $force_display_results = false, $db = false)
    {
    ...
    */
    public function display_stages($stages, $selected = 1)
    {
    ...
    */
    public function confirm_box($check, $title = '', $hidden = '', $html_body = 'index_body.html')
    {
        if (!$check) {
            global $template;
    ...
    */
    public function display_options($options)
    {
        ...
        foreach ($options as $name => $vars) {
            ...
            } elseif (isset($vars['explain']) && $vars['explain']) {
    ...
    */
    public function display_results($command = '', $result = '')
    {
    ...
    */
    public function build_cfg_template($tpl_type, $name, $vars)
    {
        global $user;
